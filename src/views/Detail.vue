    ...
    <v-container>
      <v-row class="detail py-5 my-3">
        <v-col cols="12" md="8">
          ...
          <div>
            <h2>Yacht charter in Croatia · Saxdor — 320 Gto (2022)</h2>
            <v-chip variant="text" color="green">
              <v-icon left class="pe-2">mdi-account-tie-hat</v-icon>
              <p style="color: #000">With or without a skipper</p>
            </v-chip>
            <v-chip variant="text" color="green">
              <v-icon left class="pe-2">mdi-briefcase-check-outline</v-icon>
              <p style="color: #000">Professional</p>
            </v-chip>
            <v-chip variant="text" color="green">
              <v-icon left class="pe-2">mdi-anchor</v-icon>
              <p style="color: #000">D-Marin Dalmacija</p>
            </v-chip>
            <v-divider class="my-3"></v-divider>
            <h3>Motorboat owned by Barbara</h3>
            <p>9 people · 600 horsepower · 10.3 meters</p>
            <v-divider class="my-3"></v-divider>
            ...
            <v-row class="mt-2">
              <v-col>
                <v-row class="align-start">
                  ...
                  <v-col class="pt-0">
                    <h4 class="mb-1">With or without a skipper</h4>
                    <p class="ma-0">
                      A boat license is required if you are sailing without a
                      skipper.
                    </p>
                  </v-col>
                </v-row>
                <v-row class="align-start">
                  ...
                  <v-col class="pt-0">
                    <h4 class="mb-1">Super owner</h4>
                    <p class="ma-0">
                      Barbara is an experienced boat renter with excellent
                      reviews and is committed to providing quality services.
                    </p>
                  </v-col>
                </v-row>
                <v-row class="align-start">
                  ...
                  <v-col class="pt-0">
                    <h4 class="mb-1">Perfect for watersports</h4>
                    <p class="ma-0">
                      This boat has the necessary equipment for practising
                      nautical sports (wakeboarding, water skiing...).
                    </p>
                  </v-col>
                </v-row>
              </v-col>
            ...
            <h2 class="title">Description of 42' Azimut Yacht</h2>
            <p class="description">
            ...
            <v-card-text>
              <v-form>
                ...
                <v-row>
                  <v-col cols="12">
                    <v-card-actions
                      class="actionbtn justify-center rounded mt-2 text-center text-white"
                    >
                      <v-btn
